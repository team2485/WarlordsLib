...
/**
 *
 * This is copied pasted from WPILib to use SpeedController alternative {@link MotorController}
 *
 * A class for driving differential drive/skid-steer drive platforms such as the Kit of Parts drive
 * base, "tank drive", or West Coast Drive.
 *
 * <p>These drive bases typically have drop-center / skid-steer with two or more wheels per side
 * (e.g., 6WD or 8WD). This class takes a MotorController per side.
 *
...
public class WarlordsDrive extends RobotDriveBase implements Sendable, AutoCloseable{
     ...
     *
     */
    public WarlordsDrive(MotorController leftMotor, MotorController rightMotor) {
    ...
    public void arcadeDrive(double xSpeed, double zRotation, boolean squareInputs) {
        if (!m_reported) {
            HAL.report(FRCNetComm.tResourceType.kResourceType_RobotDrive,
                    FRCNetComm.tInstances.kRobotDrive2_DifferentialArcade, 2);
            m_reported = true;
        }
    ...
    public void curvatureDrive(double xSpeed, double zRotation, boolean isQuickTurn) {
        if (!m_reported) {
            HAL.report(FRCNetComm.tResourceType.kResourceType_RobotDrive,
                    FRCNetComm.tInstances.kRobotDrive2_DifferentialCurvature, 2);
            m_reported = true;
        }
    ...
    public void tankDrive(double leftSpeed, double rightSpeed, boolean squareInputs) {
        if (!m_reported) {
            HAL.report(FRCNetComm.tResourceType.kResourceType_RobotDrive,
                    FRCNetComm.tInstances.kRobotDrive2_DifferentialTank, 2);
            m_reported = true;
        }
