...
public class ConfigsWrapper implements LoadableConfigs, SavableConfigs {
    ...
    @Override
    public float getFloat(String key, float backup) { return m_robotConfigs.getFloat(m_category, key, backup); }

    @Override
    public long getLong(String key, long backup) { return m_robotConfigs.getLong(m_category, key, backup); }
    ...
    @Override
    public void put(String key, double value) { m_robotConfigs.put(m_category, key, value); }

    @Override
    public void put(String key, float value) { m_robotConfigs.put(m_category, key, value); }

    @Override
    public void put(String key, int value) { m_robotConfigs.put(m_category, key, value); }

    @Override
    public void put(String key, long value) { m_robotConfigs.put(m_category, key, value); }

    @Override
    public void put(String key, boolean value) { m_robotConfigs.put(m_category, key, value); }
}
