package frc.team2485.WarlordsLib.math.deprecated;
...
/**
 * This class is functional, but edu.wpi.first.math.filter.SlewRateLimiter performs the same
 * functionality and as such this class is not recommended for use.
 */
public class RampRate implements Sendable, Configurable {
  ...
  public double getNextValue(double target) {
    ...
    m_scaledError =
        errorToDesired / m_maxErrorToDesired; // scaled error is now mapped between 0 and 1
