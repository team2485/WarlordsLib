...
public class PIDTalonFX extends WL_TalonFX implements Configurable, PIDMotorController<ControlMode, FeedbackDevice> {
     ...
     */
    public PIDTalonFX(int deviceID, ControlMode controlMode) {
        super(deviceID);
